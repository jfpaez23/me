...
function getImages(response){
	try{
		...
		var image = "https://www.bing.com"+xmlDoc.getElementsByTagName("urlBase")[0].textContent+"_1920x1080.jpg";
		var copyright = xmlDoc.getElementsByTagName("copyright")[0].textContent.split("(")[0];
